//This sketch will not work on an Arduino Uno because it uses too much RAM.
//Look for v2 of this sketch for a slightly modified but working variation.
...
#define DHT11_PIN 10  //Prototype 2 pin: 4
//DHTNEW mySensor(DHT11_PIN); 

//LiquidCrystal lcd(13, 12, 8, 9, 10, 11); // Prototype 2 pins
...
SoftwareSerial EspSerial(8, 9); // RX, TX - Prototype 2 pins 2, 3
...
void setup()
{
  ...
  // Setting interval to send data to Blynk Cloud to 5000ms. 
